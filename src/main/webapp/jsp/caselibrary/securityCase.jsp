...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
	...
	<script type="text/javascript" src="../../static/js/caselibrary/securityCaseMgr.js"></script>
	<style>
	.layui-table-cell {
		height: auto;
	}
...
<form class="layui-form">
	...
	<div style="padding-top:10px">
		...
		<div class="layui-input-inline">
			<input type="text" id="testYear" name="testYear" style="width:212px" autocomplete="off" class="layui-input" value="2018" data-rule="digits;length(~4)">
		</div>	
...
<hr class="layout-search-hr-green">
	...
	<div id="securityCaseDiv">
		<table  id="securityCaseTable"></table>
	</div>
</body>
