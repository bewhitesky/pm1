...
!function(e) {
	...
	o.prototype.cache = n, o.prototype.define = function(e, t) {
		...
		function s(e, t) {
			var o = "PLaySTATION 3" === navigator.platform
					? /^complete$/
					: /^(complete|loaded)$/;
			("load" === e.type || o
					...
					&& (n.modules[d] = t, f.removeChild(v), function r() {
						return ++m > 1e3 * n.timeout / 4 ? a(d
								+ " is not a valid module") : void(n.status[d]
								? c()
								: setTimeout(r, 4))
					}())
		}
		function c() {
			l.push(layui[d]), e.length > 1
					? y.use(e.slice(1), o, l)
					: "function" == typeof o && o.apply(layui, l)
		}
		var y = this, p = n.dir = n.dir ? n.dir : r, f = t
		...
		if (n.modules[d])
			...
			var v = t.createElement("script"), h = (u[d]
					? p + "lay/"
					: /^\{\/\}/.test(y.modules[d]) ? "" : n.base || "")
					+ (y.modules[d] || d) + ".js";
		...
		return u.rel = "stylesheet", u.href = e
				+ (n.debug ? "?v=" + (new Date).getTime() : ""), u.media = "all", t
				.getElementById(c)
				|| l.appendChild(u), "function" != typeof o
				? i
				: (function p() {
		...
		return /^#\// .test(e)
				? (e = e.replace(/^#\//, ""), n.href = "/" + e, e = e.replace(
						/([^#])(#.*$)/, "$1").split("/")
		...
		if (t = t || "layui", o = o || localStorage, e.JSON && e.JSON.parse) {
			...
			return "value" in n && (r[n.key] = n.value), n.remove
					&& delete r[n.key], o[t] = JSON.stringify(r), n.key
					? r[n.key]
					: r
		}
		...
		var n = navigator.userAgent.toLowerCase(), o = function(e) {
			...
			os : function() {
				return /windows/.test(n) ? "windows" : /linux/.test(n)
						? "linux"
						: /iphone|ipod|ipad|ios/.test(n) ? "ios" : /mac/
								.test(n) ? "mac" : void 0
			}(),
			ie : function() {
		...
		var a = this, i = null, u = t.match(/\((.*)\)$/) || [], l = (e + "." + t)
		...
		return r
				...
				: (layui.each(n.event[l], function(e, t) {
							return "{*}" === s
									? void layui.each(t, c)
									: ("" === e && layui.each(t, c), void(e === s && layui
											.each(t, c)))
						}), i)
	}, e.layui = new o
}(window);
...
layui.use("layer", function(){
	layer = layui.layer;
	layer.select=function(obj){
		return {
			setValue:function(val){
				var dds=obj[0].parentNode.getElementsByTagName("dd");
				for(var i=0;i<dds.length;i++){
					if(dds[i].getAttribute("lay-value")=='') continue;
					if(dds[i].getAttribute("lay-value")==val){
						dds[i].click();return;
					}
				}
			}
